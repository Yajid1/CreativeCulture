...
const initialProjects: Project[] = [
    {
        ...
        description: 'Complete online store with payment inte...',
        status: 'Ready',
    ...
    },
    {
        ...
        description: 'Cross-platform mobile application with p...',
        status: 'Ready',
        environment: 'Production',
        lastUpdated: '07/22/2026',
    },
    {
        id: 3,
        name: 'Digital Content Studio Hub',
        description: 'Multimedia studio booking and equipment reservation...',
        status: 'In Progress',
        environment: 'Staging',
    ...
    {
        id: 4,
        name: 'Exhibition Gallery Portal',
        description: 'Online exhibition display and ticketing management...',
        status: 'Ready',
        environment: 'Production',
    ...
    {
        id: 5,
        name: 'Recording Studio Maintenance Tracker',
        description: 'Soundproof room sensor log and gear maintenance...',
        status: 'Blocked',
...
export default function BCHAdmin() {
    ...
    return (
        <>
            <Head title="All Projects - Bandung Creative HUB" />
            ...
            <div className="min-h-screen bg-[#f5f7fa] dark:bg-[#09090b] text-gray-800 dark:text-gray-200 p-4 sm:p-6 lg:p-8 space-y-6 pb-16 font-sans">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs sm:text-sm font-medium text-gray-400 dark:text-gray-400 mt-1">
                            Manage development projects and deployments
                        </p>
                    </div>
                ...
                {/* 3. STAT CARDS ROW WITH WATERMARK ICONS */}
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-gray-100 dark:border-[#1f1f23] bg-white dark:bg-[#121215] p-5 shadow-xs transition hover:shadow-sm">
                        ...
                        <Folder className="absolute -right-3 -bottom-3 h-20 w-20 text-gray-100/60 dark:text-gray-800/10 pointer-events-none stroke-[1]" />
                    </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-[#1c1c21]">
                                {filteredProjects.map((project) => (
                                    ...
                                    >
                                        {/* Name & Subtext with Icon Thumbnail */}
                                        ...
                                        <td className="py-4 px-5">
                                            ...
                                            {project.status === 'Blocked' && (
                                                <span className="inline-flex items-center rounded-full bg-red-50 dark:bg-red-950/60 px-3.5 py-1 text-[11px] font-bold text-red-600 dark:text-red-400 border border-red-100 dark:border-red-800/40">
                                                    Blocked
                                                </span>
                                            )}
                                        </td>
