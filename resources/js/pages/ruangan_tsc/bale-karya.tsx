...
export default function BaleKarya({ room }: { room?: UserRoomData | null }) {
    ...
    const facilitiesList = [
        '🎨 Studio Pameran Karya Seni & Galeri',
        '🖼️ Panel & Dinding Display Lukisan / Kriya',
        '💡 Lighting Galeri & Pencahayaan Pameran',
        '🪑 Meja & Stand Display Karya',
        '🪵 Ornamen Interior Bambu Etnis Sunda',
        '👥 Kapasitas Hingga 50 Pengunjung',
    ];

    return (
        <>
            <Head title="Balé Karya - Teras Sunda Cibiru" />
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3.5 py-1 text-xs font-bold uppercase tracking-wider text-emerald-700">
                                Studio Pameran & Apresiasi Karya
                            </div>
                            ...
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Sebuah studio pameran karya seni yang bisa wargi kunjungi langsung selama jam operasional berlangsung. Selain itu, Balé Karya menjadi sarana pameran karya seni bagi para seniman kriya, lukis, hingga pernak-pernik budaya.
                            </p>
                            ...
                            <div className="mt-6 flex flex-wrap items-center gap-3">
                                ...
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-emerald-50/60 border border-emerald-100 px-5 py-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-extrabold text-gray-900">Galeri & Apresiasi Seni</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Balé Karya Teras Sunda Cibiru"
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-2 lg:order-1 lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Pameran Kriya & Lukis Balé Karya"
                                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                                />
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Sarana Pameran Kriya, Lukis & Budaya
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Balé Karya dirancang khusus dengan nuansa ornamen bambu yang estetis sebagai etalase karya seni kriya, seni lukis, karya pahat, dan pernak-pernik kebudayaan Sunda.
                            </p>

                            {/* Facilities Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Daftar Fasilitas Balé Karya:</p>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Ruang Pameran & Apresiasi Karya Seni di Cibiru.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Sarana berkreasi dan memamerkan ragam seni rupa, kerajinan kriya, serta warisan budaya Sunda bagi publik dan seniman lokal.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                ...
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas pengunjung studio pameran karya seni.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                <div className="flex flex-1 flex-col items-center justify-center rounded-2xl border-2 border-dashed border-emerald-200 bg-emerald-50/40 p-5 text-center">
                                    ...
                                    <p className="mt-1 text-xs font-semibold text-emerald-700">Pameran & Apresiasi Karya</p>
                                </div>

                                <div className="mt-3 rounded-2xl bg-emerald-600 text-white p-4 flex items-center justify-between">
                                    <h4 className="text-xs font-extrabold uppercase">BALÉ KARYA</h4>
                                    <span className="text-[11px] font-semibold text-emerald-100">Kriya, Lukis & Budaya</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#F4F4F5] p-6 min-h-[260px]">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="mt-1 text-xs text-gray-500 leading-relaxed">
                                        Pengajuan pameran via Hotline Teras Sunda Cibiru di jam 08.00–16.00 WIB.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-emerald-600 uppercase">BALÉ KARYA</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Ruang galeri di Balé Karya sangat pas untuk memamerkan produk kriya etnis dan pameran seni rupa lokal."
                                    </p>
                                </div>

                                <p className="text-[11px] font-semibold text-gray-400">
                                    • Seniman Kriya Bandung
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan pameran dan syarat penggunaan Balé Karya di Teras Sunda Cibiru.
                            </p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Cek ketersediaan jadwal pameran di fitur live schedule resmi Teras Sunda Cibiru.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-emerald-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Konfirmasi ketersediaan galeri ke hotline Teras Sunda Cibiru di jam 08.00–16.00 WIB, dengan melampirkan KTP Kota Bandung dan proposal/deskripsi karya yang akan dipamerkan.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-emerald-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Membuat Surat Pengajuan dan Lembar Deskripsi Kegiatan Pameran lalu serahkan ke Front Office UPTD sebelum pameran berlangsung.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-600">
                                            Selama kegiatan/pameran berlangsung, penanggung jawab <strong className="text-emerald-800">wajib menyimpan KTP ke Operator / Sekuriti yang bertugas</strong>.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">FOTO BALÉ KARYA {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
