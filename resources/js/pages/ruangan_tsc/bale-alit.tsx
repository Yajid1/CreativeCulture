...
export default function BaleAlit({ room }: { room?: UserRoomData | null }) {
    ...
    const facilitiesList = [
        '🎪 Area Semi Terbuka Beratap Bambu khas Sunda',
        '💃 Area Latihan Tari, Suara & Teater',
        '📍 Tepat di Belakang Balé Utama',
        '🌿 Sirkulasi Udara Segar & Nyaman',
        '👥 Kapasitas Berkelompok Hingga 20 Orang',
        '🪑 Fasilitas Alat & Cermin Latihan Seni',
    ];

    return (
        <>
            <Head title="Balé Alit - Teras Sunda Cibiru" />
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Sebuah area semi terbuka yang berfungsi sebagai sarana latihan seni secara berkelompok. Letak Balé Alit berada tepat di belakang Balé Utama. Sebagai area semi terbuka, Balé Alit dapat menampung hingga 20 orang.
                            </p>
                            ...
                            <div className="mt-6 flex flex-wrap items-center gap-3">
                                ...
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-emerald-50/60 border border-emerald-100 px-5 py-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-extrabold text-gray-900">Semi Terbuka</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Balé Alit Teras Sunda Cibiru"
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-2 lg:order-1 lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Fasilitas Latihan Balé Alit"
                                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                                />
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Sarana Latihan Seni Berkelompok
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Balé Alit dirancang sebagai ruang latihan semi terbuka yang asri dan sejuk. Sangat cocok bagi para pegiat seni untuk mengolah vokal, gerak tari, dan olah peran teater.
                            </p>

                            {/* Facilities Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Daftar Fasilitas Balé Alit:</p>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Ruang Latihan Pertunjukan Seni di Teras Sunda Cibiru.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Menyediakan sarana latihan seni semi terbuka beratap bambu khas Sunda tepat di belakang Balé Utama.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                ...
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas maksimal orang dalam satu grup latihan seni.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                ...
                                <div className="mt-3 rounded-2xl bg-emerald-600 text-white p-4 flex items-center justify-between">
                                    <h4 className="text-xs font-extrabold uppercase">BALÉ ALIT</h4>
                                    <span className="text-[11px] font-semibold text-emerald-100">Belakang Balé Utama</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-emerald-600 uppercase">BALÉ ALIT</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Suasana semi terbuka di Balé Alit sangat mendukung konsentrasi saat olah rasa dan latihan koreografi tari."
                                    </p>
                                </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan latihan dan syarat penggunaan Balé Alit di Teras Sunda Cibiru.
                            </p>
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">FOTO BALÉ ALIT {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
