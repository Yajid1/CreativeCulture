...
export default function WahanaKaulinanLapang({ room }: { room?: UserRoomData | null }) {
    ...
    const facilitiesList = [
        '🌱 Lapangan Rumput Terbuka Hijau (Open Field)',
        '🪁 Peralatan Kaulinan Barudak (Egrang, Bakiak, Kelom Geulis, Gasing)',
        '🔊 Sound System Outdoor & Pengeras Suara Acara',
        '🌄 View Panorama Pegunungan Manglayang',
        '👨‍👩‍👧‍👦 Sarana Edukasi Permainan Tradisional Anak & Outbound',
        '👥 Kapasitas Pengunjung Terbuka Hingga 100 Orang',
    ];

    return (
        <>
            <Head title="Wahana Kaulinan Lapang - Kampung Wisata Pasir Kunci" />
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3.5 py-1 text-xs font-bold uppercase tracking-wider text-emerald-700">
                                Area Kaulinan Barudak & Gathering
                            </div>

                            <h1 className="mt-3 text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Wahana Kaulinan Lapang
                            </h1>
                            <p className="mt-2 text-sm font-semibold text-emerald-600">
                                Kampung Wisata Pasir Kunci
                            </p>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Wahana Kaulinan Lapang merupakan area lapang terbuka hijau di Kampung Wisata Pasir Kunci dengan kapasitas hingga 100 orang. Area ini difungsikan secara khusus sebagai ruang pelestarian permainan tradisional Sunda (Kaulinan Barudak) seperti egrang, bakiak, kelom geulis, gasing, serta festival edukasi budaya anak dan outdoor gathering.
                            </p>
                            ...
                            <div className="mt-6 flex flex-wrap items-center gap-3">
                                ...
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-emerald-50/60 border border-emerald-100 px-5 py-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-medium text-emerald-600 uppercase tracking-wider">Fungsi Utama</p>
                                        <p className="text-base font-extrabold text-gray-900">Permainan Tradisional Sunda</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Wahana Kaulinan Lapang Pasir Kunci"
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-2 lg:order-1 lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Permainan Tradisional Kaulinan Barudak"
                                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                                />
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Pelestarian Kaulinan Barudak Sunda
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Menjadi wahana edukasi luar ruangan yang menyenangkan bagi anak-anak dan wisatawan untuk mengenal serta memainkan aneka permainan tradisional khas Sunda.
                            </p>

                            {/* Facilities Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Daftar Fasilitas Lapangan:</p>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Arena Permainan Tradisional & Outbound Budaya.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Menyediakan area rumput terbuka hijau berkapasitas 100 orang untuk aktivitas kaulinan barudak, outbound keluarga, dan gathering outdoor.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                <div>
                                    ...
                                    <h3 className="mt-8 text-4xl sm:text-5xl font-extrabold tracking-tight text-white">100</h3>
                                </div>
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas pengunjung di wahana kaulinan lapang.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                <div className="flex flex-1 flex-col items-center justify-center rounded-2xl border-2 border-dashed border-emerald-200 bg-emerald-50/40 p-5 text-center">
                                    ...
                                    <p className="mt-1 text-xs font-semibold text-emerald-700">Kaulinan Barudak & Gathering</p>
                                </div>

                                <div className="mt-3 rounded-2xl bg-emerald-600 text-white p-4 flex items-center justify-between">
                                    <h4 className="text-xs font-extrabold uppercase">KAULINAN LAPANG</h4>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#F4F4F5] p-6 min-h-[260px]">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="mt-1 text-xs text-gray-500 leading-relaxed">
                                        Pengajuan diproses via Hotline Pasir Kunci di jam 08.00–16.00 WIB.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-emerald-600 uppercase">PASIR KUNCI</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Anak-anak sangat senang belajar bermain egrang dan bakiak di lapangan terbuka Pasir Kunci."
                                    </p>
                                </div>

                                <p className="text-[11px] font-semibold text-gray-400">
                                    • Komunitas Kaulinan Barudak
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan dan syarat penggunaan Wahana Kaulinan Lapang di Kampung Wisata Pasir Kunci.
                            </p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Cek ketersediaan jadwal lapangan di fitur live schedule resmi Pasir Kunci.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-emerald-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Konfirmasi ketersediaan lapangan ke hotline Pasir Kunci di jam 08.00–16.00 WIB, dengan melampirkan KTP Kota Bandung.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">FOTO WAHANA KAULINAN {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
