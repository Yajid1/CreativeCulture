...
const initialProjects: Project[] = [
    {
        id: 1,
        name: 'Gedung Outdoor Stage Renovation',
        description: 'Sound setup & stage expansion for outdoor cultural...',
        status: 'Ready',
    ...
    {
        id: 2,
        name: 'Music Studio Acoustic Upgrade',
        description: 'Soundproofing and digital mixing board installation...',
        status: 'Ready',
        environment: 'Production',
        lastUpdated: '07/22/2026',
    },
    {
        id: 3,
        name: 'Indoor Main Stage Lighting',
        description: 'DMX theatrical lighting setup & control system...',
        status: 'In Progress',
        environment: 'Staging',
    ...
    {
        id: 4,
        name: 'Traditional Dance Rehearsal Suite',
        description: 'Mirror installation and wooden flooring treatment...',
        status: 'Ready',
        environment: 'Production',
    ...
    {
        id: 5,
        name: 'Cultural Festival Booking App',
        description: 'Online ticket and space reservation module...',
        status: 'Blocked',
...
export default function PSMSAdmin() {
    ...
    return (
        <>
            <Head title="All Projects - Padepokan Seni Mayang Sunda" />
