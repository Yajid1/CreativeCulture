...
export default function IndoorStage({ room }: { room?: UserRoomData | null }) {
    ...
    const facilitiesList = [
        '🎭 Panggung (20 x 8 x 0,6 m) Bidang Setengah Lingkaran',
        '💺 Kursi Bioskop (Kapasitas 150 Penonton)',
        '🎛️ Mixer Yamaha MGP24X & Mixer Lampu',
        '⚡ Power Supply & Equalizer DBX',
        '🔊 Speaker M12, Speaker M15 & Speaker Hooper',
        '📻 Subwoofer Behringer & Subwoofer JBX100',
        '📹 Screen Projector',
        '💡 Lampu PAR LED, Lampu Cerobong & Lampu Tembak',
        '🎙️ Stand Mic',
    ];
    ...
    return (
        <>
            <Head title="Indoor Stage - Padepokan Seni Mayang Sunda" />
            ...
            <div className="min-h-screen bg-white text-gray-900 font-sans">
                ...
                <main className="mx-auto max-w-7xl px-6 py-16 sm:px-12 lg:px-20 space-y-24">
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Salah satu fasilitas utama dari Gedung Mayang Sunda adalah Indoor Stage. Area dengan kapasitas 150 penonton ini, merupakan area tertutup ber-AC, yang berfungsi sebagai ruang pertunjukan seni dan budaya. Fasilitas Indoor Stage meliputi panggung, backdrop, sound system, lighting, dan lainnya.
                            </p>
                            ...
                            <div className="mt-6 flex flex-wrap items-center gap-3">
                                ...
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-emerald-50/60 border border-emerald-100 px-5 py-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-medium text-emerald-600 uppercase tracking-wider">Fasilitas Ruang</p>
                                        <p className="text-base font-extrabold text-gray-900">Tertutup Ber-AC</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Indoor Stage Padepokan Seni Mayang Sunda"
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-2 lg:order-1 lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Fasilitas Panggung Indoor Stage Mayang Sunda"
                                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                                />
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Panggung & Sound System Lengkap
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Dilengkapi panggung berbidang setengah lingkaran (20 x 8 x 0,6 m), tempat duduk model Kursi Bioskop yang nyaman, serta sistem audio-visual terpadu untuk performa maksimal.
                            </p>

                            {/* Facilities Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Daftar Peralatan & Fasilitas:</p>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Ruang Pertunjukan Seni & Budaya di Bandung.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Menyediakan panggung pertunjukan setengah lingkaran dengan tata pencahayaan profesional, akustik memadai, serta kenyamanan kursi penonton bioskop.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                <div>
                                    ...
                                    <h3 className="mt-8 text-4xl sm:text-5xl font-extrabold tracking-tight text-white">150</h3>
                                </div>
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas penonton duduk dengan fasilitas Kursi Bioskop dan ruangan ber-AC.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                <div className="flex flex-1 flex-col items-center justify-center rounded-2xl border-2 border-dashed border-emerald-200 bg-emerald-50/40 p-5 text-center">
                                    ...
                                    <p className="mt-1 text-xs font-semibold text-emerald-700">Sesi 1: 08.00–13.00 | Sesi 2: 15.00–20.00</p>
                                </div>

                                <div className="mt-3 rounded-2xl bg-emerald-600 text-white p-4 flex items-center justify-between">
                                    <h4 className="text-xs font-extrabold uppercase">PANGGUNG 20x8M</h4>
                                    <span className="text-[11px] font-semibold text-emerald-100">Setengah Lingkaran</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#F4F4F5] p-6 min-h-[260px]">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="mt-1 text-xs text-gray-500 leading-relaxed">
                                        Pengajuan diproses via Hotline Mayang Sunda di jam 08.00–16.00 WIB.
                                    </p>
                                    <a
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-emerald-600 uppercase">MAYANG SUNDA</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Wadah pertunjukan seni dan budaya Sunda yang representatif dengan panggung akustik dan pencahayaan yang sangat mendukung."
                                    </p>
                                </div>

                                <p className="text-[11px] font-semibold text-gray-400">
                                    • Seniman & Komunitas Bandung
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan dan syarat penggunaan Indoor Stage di Padepokan Seni Mayang Sunda.
                            </p>
                        ...
                        <div className="lg:col-span-7 space-y-4">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Cek ketersediaan jadwal penggunaan ruangan di fitur live schedule: <a href="https://linktr.ee/mayangsunda" target="_blank" rel="noopener noreferrer" className="text-emerald-600 font-semibold underline">linktr.ee/mayangsunda</a>.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-emerald-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Konfirmasi ketersediaan ruangan ke hotline Mayang Sunda di jam 08.00–16.00 WIB, dengan melampirkan KTP Kota Bandung dan daftar lampiran alat yang dibawa (jika ada).
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-emerald-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Membuat Surat Pengajuan dan Lembar Deskripsi Kegiatan (meliputi Tema Acara, Rundown, Jumlah Peserta, Waktu Pelaksanaan) lalu serahkan ke Front Office UPTD.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-emerald-200 bg-emerald-50/50 p-6 shadow-xs transition hover:bg-emerald-50/80">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Penyimpanan KTP ke Operator</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-600">
                                            Selama acara berlangsung, penanggung jawab kegiatan <strong className="text-emerald-800">wajib menyimpan KTP ke Operator yang bertugas</strong>.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    {/* ===== 2-ROW INFINITE MARQUEE IMAGE CAROUSEL WITH DSC IMAGES ===== */}
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">FOTO INDOOR STAGE {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
