...
export default function Palataran({ room }: { room?: UserRoomData | null }) {
    ...
    const facilitiesList = [
        '🎪 Area Pelataran Terbuka (Open-Air Courtyard)',
        '🎭 Panggung Portabel & Stand Pertunjukan',
        '🔊 Sound System Portabel & Speaker System',
        '🪑 Kursi Lipat / Portabel (50 Unit)',
        '💡 Penerangan & Outdoor Lighting',
        '🌿 Sirkulasi Udara Alami & Suasana Asri Ruang Terbuka Hijau',
    ];

    return (
        <>
            <Head title="Palataran - Teras Sunda Cibiru" />
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Palataran merupakan area pelataran terbuka berkonsep ramah lingkungan di Teras Sunda Cibiru yang berkapasitas 50 penonton. Berada di ruang terbuka hijau dengan sirkulasi udara alami, area ini sangat ideal untuk berbagai kegiatan seni budaya outdoor seperti latihan tari, bazaar karya kreatif, pertunjukan musik akustik, gathering komunitas, hingga workshop kebudayaan Sunda.
                            </p>
                            ...
                            <div className="mt-6 flex flex-wrap items-center gap-3">
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-gray-50 border border-gray-100 px-5 py-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-extrabold text-gray-900">50 Orang</p>
                                    </div>
                                </div>
                                ...
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-emerald-50/60 border border-emerald-100 px-5 py-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-medium text-emerald-600 uppercase tracking-wider">Konsep Area</p>
                                        <p className="text-base font-extrabold text-gray-900">Open-Air Courtyard</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Palataran Teras Sunda Cibiru"
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-2 lg:order-1 lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Fasilitas Palataran Teras Sunda Cibiru"
                                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                                />
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Suasana Terbuka & Sirkulasi Alami
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Dilengkapi dengan sound system portabel, penerangan outdoor, serta opsi panggung portabel dan kursi lipat untuk mendukung berbagai kemasan acara seni dan budaya.
                            </p>

                            {/* Facilities Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Daftar Fasilitas Palataran:</p>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Ruang Kreatif Terbuka di Teras Sunda Cibiru.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Menyediakan pelataran terbuka ramah lingkungan untuk pertunjukan etnis, latihan komunitas, hingga bazaar karya seni di Bandung Timur.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                <div>
                                    ...
                                    <h3 className="mt-8 text-4xl sm:text-5xl font-extrabold tracking-tight text-white">50</h3>
                                </div>
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas pengunjung di area pelataran terbuka.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                ...
                                <div className="mt-3 rounded-2xl bg-emerald-600 text-white p-4 flex items-center justify-between">
                                    <h4 className="text-xs font-extrabold uppercase">PALATARAN</h4>
                                    <span className="text-[11px] font-semibold text-emerald-100">Open Air</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#F4F4F5] p-6 min-h-[260px]">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="mt-1 text-xs text-gray-500 leading-relaxed">
                                        Pengajuan diproses via Hotline Teras Sunda Cibiru di jam 08.00–16.00 WIB.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-emerald-600 uppercase">TERAS SUNDA CIBIRU</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Palataran Teras Sunda Cibiru menawarkan ruang terbuka yang sangat nyaman untuk pentas seni tradisional dan ruang interaksi budaya."
                                    </p>
                                </div>

                                <p className="text-[11px] font-semibold text-gray-400">
                                    • Komunitas Seni Cibiru
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan dan syarat penggunaan Palataran di Teras Sunda Cibiru.
                            </p>
                        ...
                        <div className="lg:col-span-7 space-y-4">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Cek ketersediaan jadwal penggunaan area di fitur live schedule resmi Teras Sunda Cibiru.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-emerald-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Konfirmasi ketersediaan area ke hotline Teras Sunda Cibiru di jam 08.00–16.00 WIB, dengan melampirkan KTP Kota Bandung dan daftar lampiran alat yang dibawa (jika ada).
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-emerald-200 bg-emerald-50/50 p-6 shadow-xs transition hover:bg-emerald-50/80">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Penyimpanan KTP ke Operator / Sekuriti</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-600">
                                            Selama acara berlangsung, penanggung jawab kegiatan <strong className="text-emerald-800">wajib menyimpan KTP ke Operator / Sekuriti yang bertugas</strong>.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">FOTO PALATARAN {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
