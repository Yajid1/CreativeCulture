...
export default function KampungWisataPasirKunci() {
    const facility = {
        ...
        description:
            'Kawasan seni budaya lereng Gunung Manglayang yang menyajikan suasana asri pedesaan, pelestarian permainan tradisional Sunda (kaulinan lembur), dan wisata edukasi ramah anak.',
