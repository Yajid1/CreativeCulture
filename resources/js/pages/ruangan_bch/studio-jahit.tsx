...
export default function StudioJahit({ room }: { room?: UserRoomData | null }) {
    ...
    return (
        <>
            <Head title="Studio Jahit (Lt.4) - Bandung Creative Hub" />
            ...
            <div className="min-h-screen bg-white text-gray-900 font-sans">
                ...
                <main className="mx-auto max-w-7xl px-6 py-16 sm:px-12 lg:px-20 space-y-24">
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Studio Jahit terletak di dekat taman lantai 4. Studio ini berfungsi sebagai sarana penciptaan olahan kriya dan fesyen jahit. Fasilitas yang tersedia di studio ini berupa mesin jahit, mesin obras, mesin bordir, serta seperangkat benang jahit.
                            </p>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm">
                                <img
                                    ...
                                    alt="Studio Jahit Bandung Creative Hub"
                    ...
                    {/* ===== ROW 2: FASHION & CRAFT MACHINES (IMAGE LEFT, TEXT RIGHT) ===== */}
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Fasilitas Jahit, Obras & Bordir
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Sangat cocok untuk pembuatan Olahan Kriya dan Produk Fesyen Jahit bagi para desainer busana, pengrajin kriya, maupun penggiat subsektor fashion.
                            </p>

                            {/* Facilities Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Peralatan Studio Jahit:</p>
                                <div className="flex flex-wrap gap-2 text-xs">
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">🧵 Mesin Jahit JUKI HZL-27z (5 Unit)</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">✂️ Mesin Obras JUKI MO-50e (2 Unit)</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">🪡 Mesin Bordir Surya S-1201PT (1 Unit)</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">🪑 Kursi Kerja (7 Unit)</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">🧶 Perangkat Benang & Peralatan Jahit</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Studio Penciptaan Olahan Kriya & Fesyen Jahit di Lantai 4 BCH.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Menyediakan 5 unit mesin jahit JUKI, mesin obras, dan mesin bordir komputer Surya untuk kreator fesyen.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                ...
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas maksimal orang dalam studio jahit.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                ...
                                <div className="mt-3 rounded-2xl bg-amber-50 border border-amber-100 p-4 flex items-center justify-between text-amber-800">
                                    <h4 className="text-xs font-extrabold">JUKI HZL-27Z</h4>
                                    <span className="text-[11px] font-semibold">Bordir Surya</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-gray-400 uppercase">STUDIO JAHIT</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Keberadaan mesin jahit JUKI dan mesin bordir Surya di BCH sangat mempermudah pembuatan sampel karya fesyen kriya."
                                    </p>
                                </div>

                                <p className="text-[11px] font-semibold text-gray-400">
                                    • Pengrajin Fesyen Bandung
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan reservasi dan ketentuan penggunaan Studio Jahit di lantai 4 Bandung Creative Hub.
                            </p>
                            ...
                            <div className="mt-8 rounded-2xl border border-gray-200 bg-gray-50/80 p-5">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Jam Operasional Studio Jahit</p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Pengaju wajib ber-KTP Kota Bandung untuk dapat mengakses dan meminjam fasilitas Studio Jahit.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-600">
                                            Selama kegiatan jahit berlangsung, penanggung jawab wajib menyimpan/menitipkan KTP kepada Operator yang bertugas.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">Foto Studio Jahit {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
