...
export default function StudioMusikMayangSunda({ room }: { room?: UserRoomData | null }) {
    ...
    const facilitiesList = [
        '🎙️ Microphone',
        '🎸 Gitar Elektrik & Bass Elektrik',
        '🥁 Drum Pearl',
        '🎛️ Power Mixer Yamaha MG16XU',
        '📻 Amplifier Blackstar ID Core 100',
        '🔊 Speaker Yamaha 15”',
        '🎼 Angklung Toél',
        '🪕 Kacapi Akustik Elektrik',
        '🪈 Suling',
        '🔔 Bonang, Saron 1, Saron 2, Jenglong',
        '🥁 Kendang & Goong',
    ];

    return (
        <>
            <Head title="Studio Musik Mayang Sunda - Padepokan Seni Mayang Sunda" />
            ...
            <div className="min-h-screen bg-white text-gray-900 font-sans">
                ...
                <header className="sticky top-0 z-40 border-b border-gray-100 bg-white/90 backdrop-blur-md">
                    <div className="flex items-center justify-between gap-6 px-6 py-4 sm:px-10">
                        ...
                        <nav className="hidden items-center gap-7 text-sm font-medium text-gray-500 lg:flex" aria-label="Primary">
                            ...
                            <Link href="/fasilitas/padepokan-seni-mayang-sunda" className="transition hover:text-gray-900">
                ...
                <main className="mx-auto max-w-7xl px-6 py-16 sm:px-12 lg:px-20 space-y-24">
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3.5 py-1 text-xs font-bold uppercase tracking-wider text-emerald-700">
                                Studio Musik Tradisional & Modern
                            </div>

                            <h1 className="mt-3 text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Studio Musik Mayang Sunda
                            </h1>
                            <p className="mt-2 text-sm font-semibold text-emerald-600">
                                Padepokan Seni Mayang Sunda
                            </p>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Sebuah studio musik gratis terbaru di Kota Bandung dengan perangkat tambahan seperti gamelan pélog, kacapi, suling, dan angklung toél. Cocok untuk dimanfaatkan sebagai sarana latihan musik tradisional, modern, dan kontemporer.
                            </p>
                            ...
                            <div className="mt-6 flex flex-wrap items-center gap-3">
                                ...
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-emerald-50/60 border border-emerald-100 px-5 py-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-medium text-emerald-600 uppercase tracking-wider">Alat Musik</p>
                                        <p className="text-base font-extrabold text-gray-900">Tradisional & Modern</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-2 lg:order-1 lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Peralatan Studio Musik Mayang Sunda"
                                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                                />
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Kelengkapan Alat Musik Lengkap
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Memadukan instrumen modern seperti Drum Pearl, Gitar/Bass Elektrik, Amplifier Blackstar & Mixer Yamaha dengan instrumen etnis Sunda seperti Gamelan Pélog, Kacapi, Suling, Angklung Toél, Kendang, dan Goong.
                            </p>

                            {/* Facilities Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Daftar Peralatan Studio:</p>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Studio Musik Etnis & Modern Gratis di Kota Bandung.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Mewadahi eksplorasi musik tradisional dan kontemporer untuk musisi, grup musik, dan komunitas di Bandung.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                <div>
                                    ...
                                    <h3 className="mt-8 text-4xl sm:text-5xl font-extrabold tracking-tight text-white">10</h3>
                                </div>
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas maksimal personil per sesi latihan musik.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                <div className="flex flex-1 flex-col items-center justify-center rounded-2xl border-2 border-dashed border-emerald-200 bg-emerald-50/40 p-5 text-center">
                                    <h4 className="text-xl font-extrabold text-gray-900">3 Sesi / Hari</h4>
                                    <p className="mt-1 text-xs font-semibold text-emerald-700">15.00–17.00 | 17.00–19.00 | 19.00–21.00</p>
                                </div>

                                <div className="mt-3 rounded-2xl bg-emerald-600 text-white p-4 flex items-center justify-between">
                                    <h4 className="text-xs font-extrabold uppercase">GRATIS</h4>
                                    <span className="text-[11px] font-semibold text-emerald-100">Max 1 Sesi / Hari</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#F4F4F5] p-6 min-h-[260px]">
                                ...
                                <div className="text-center">
                                    ...
                                    <a
                                        href="https://linktr.ee/mayangsunda"
                                        target="_blank"
                            ...
                            {/* Card 4: Quote Card */}
                            <div className="flex flex-col justify-between rounded-3xl bg-[#ffffff] p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        <span className="text-3xl font-serif leading-none text-emerald-300">“</span>
                                        <span className="text-[11px] font-extrabold tracking-wider text-emerald-600 uppercase">STUDIO MUSIK</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Fasilitas gamelan pélog dan kacapi di Studio Musik Mayang Sunda sangat membantu latihan musik kolaborasi etnis & modern."
                                    </p>
                                </div>

                                <p className="text-[11px] font-semibold text-gray-400">
                                    • Musisi Karawitan Bandung
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan dan pembagian jadwal sesi Studio Musik di Padepokan Seni Mayang Sunda.
                            </p>

                            {/* Operational Sessions Box */}
                            <div className="mt-8 rounded-2xl border border-emerald-100 bg-emerald-50/50 p-5 space-y-3">
                                <p className="text-xs font-bold text-emerald-800 uppercase tracking-wider">Jadwal Sesi Harian (3 Sesi / Hari):</p>
                                <div className="space-y-2 text-xs font-bold text-gray-800">
                                    <div className="flex items-center justify-between rounded-xl bg-white px-4 py-2.5 border border-emerald-100">
                                        <span>Sesi 1</span>
                                        <span className="text-emerald-700">15.00 – 17.00 WIB</span>
                                    </div>
                                    <div className="flex items-center justify-between rounded-xl bg-white px-4 py-2.5 border border-emerald-100">
                                        <span>Sesi 2</span>
                                        <span className="text-emerald-700">17.00 – 19.00 WIB</span>
                                    </div>
                                    <div className="flex items-center justify-between rounded-xl bg-white px-4 py-2.5 border border-emerald-100">
                                        <span>Sesi 3</span>
                                        <span className="text-emerald-700">19.00 – 21.00 WIB</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7 space-y-4">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Cek ketersediaan jadwal di fitur live schedule: <a href="https://linktr.ee/mayangsunda" target="_blank" rel="noopener noreferrer" className="text-emerald-600 font-semibold underline">linktr.ee/mayangsunda</a>.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-emerald-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Hubungi Hotline & Lampirkan KTP + Personil</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Hubungi hotline di jam 08.00–16.00 WIB, lampirkan KTP Kota Bandung dan daftar nama-nama personil.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-emerald-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Surat Pernyataan & Titip KTP Sekuriti</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Mengisi Surat Pernyataan di Front Office sebelum sesi berlangsung. Selama sesi berjalan, penanggung jawab wajib menyimpan KTP di sekuriti.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-600">
                                            Pengajuan maksimal <strong className="text-emerald-800">1 sesi per hari</strong>. Pengajuan lanjutan diperkenankan setelah sesi yang sedang berlangsung berakhir.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">FOTO STUDIO MUSIK MAYANG SUNDA {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between border-t border-gray-100 pt-10">
                        <Link
                            href="/fasilitas/padepokan-seni-mayang-sunda"
                        ...
                        >
                            ...
                            Kembali ke Padepokan Seni Mayang Sunda
                        </Link>
                    </div>
