...
const initialProjects: Project[] = [
    {
        id: 1,
        name: 'Balé Utama Sound Installation',
        description: 'Line array speaker rigging and digital console setup...',
        status: 'Ready',
    ...
    {
        id: 2,
        name: 'Palataran Outdoor Lighting System',
        description: 'Ambient LED floodlights and stage spot lights...',
        status: 'Ready',
        environment: 'Production',
        lastUpdated: '07/22/2026',
    },
    {
        id: 3,
        name: 'Balé Alit Workshop Area',
        description: 'Craft exhibition display racks and AC upgrade...',
        status: 'In Progress',
        environment: 'Staging',
    ...
    {
        id: 4,
        name: 'Balé Riung VIP Meeting Lounge',
        description: 'Interior renovation & video conference integration...',
        status: 'Ready',
        environment: 'Production',
    ...
    {
        id: 5,
        name: 'Balé Motékar Exhibition Room',
        description: 'Smart kiosk and interactive touchscreen display...',
        status: 'Blocked',
...
export default function TSCAdmin() {
    ...
    return (
        <>
            <Head title="All Projects - Teras Sunda Cibiru" />
