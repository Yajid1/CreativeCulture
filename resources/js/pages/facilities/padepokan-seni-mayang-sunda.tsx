            ...
            <footer className="bg-gray-900 px-6 pt-16 pb-8 text-gray-400 sm:px-10">
                <div className="mx-auto max-w-6xl">
                    ...
                    <div className="grid grid-cols-1 gap-10 border-b border-white/10 pb-12 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        {/* Kolom 1 — Branding */}
                        <div>
                            <p className="text-base font-bold text-white">Padepokan Seni Mayang Sunda</p>
                            <p className="mt-1 text-xs text-gray-500">Jl. Peta No.209, Suka Asih,<br />Kec. Bojongloa Kaler, Kota Bandung<br />Jawa Barat 40231</p>
                        ...
                        <div>
                            ...
                            <ul className="mt-4 space-y-2 text-sm">
                                {['Indoor Stage', 'Gedung Outdoor', 'Studio Musik Mayang Sunda'].map(f => (
                                    <li key={f}>
                        ...
                        <div>
                            ...
                            <a href="mailto:info@padepokanmayangsunda.id" className="mt-1 block text-sm text-white hover:underline">
                                info@padepokanmayangsunda.id
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 flex flex-col items-center justify-between gap-4 text-xs text-gray-600 sm:flex-row">
                        <p>© {new Date().getFullYear()} Padepokan Seni Mayang Sunda — Dinas Pariwisata Kota Bandung. Hak cipta dilindungi.</p>
