...
export default function ExhibitionArea({ room }: { room?: UserRoomData | null }) {
    ...
    return (
        <>
            <Head title="Exhibition Area (Lt.1) - Bandung Creative Hub" />
            ...
            <div className="min-h-screen bg-white text-gray-900 font-sans">
                ...
                <main className="mx-auto max-w-7xl px-6 py-16 sm:px-12 lg:px-20 space-y-24">
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            <h1 className="mt-3 text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Exhibition Area (Lt.1)
                            </h1>
                            <p className="mt-2 text-sm font-semibold text-gray-500">
                                Bandung Creative Hub
                            </p>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Ruang khusus pameran di Bandung Creative Hub ini berada di lantai 1. Beragam jenis pameran mulai dari seni rupa, seni kriya, fotografi, Desain Komunikasi Visual (DKV), hingga pameran karya kreatif lainnya dapat digelar di ruang dengan tampilan visual menjorok langsung ke Jalan Laswi Bandung.
                            </p>
                            ...
                            <div className="mt-6 inline-flex items-center gap-3 rounded-2xl bg-gray-50 border border-gray-100 px-5 py-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-base font-extrabold text-gray-900">100 Orang</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm">
                                <img
                                    ...
                                    alt="Exhibition Area Bandung Creative Hub"
                    ...
                    {/* ===== ROW 2: DISPLAY EQUIPMENT (IMAGE LEFT, TEXT RIGHT) ===== */}
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Fasilitas Display Pameran
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Exhibition Area lantai 1 telah dilengkapi sarana display pendukung pameran agar penyajian karya seni dan karya desain terlihat profesional dan menarik.
                            </p>

                            {/* Display Equipment List Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Daftar Peralatan Display:</p>
                                <div className="flex flex-wrap gap-2 text-xs">
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">🖼️ Display Foto (10 Unit)</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">🗄️ Meja Display (4 Unit)</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">📚 Rak Display (1 Unit)</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">📦 Box Display (3 Unit)</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">🏛️ Pedestal Display (5 Unit)</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Ruang Pameran Strategis Menghadap Jalan Laswi Bandung.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Menyediakan sarana apresiasi karya seni rupa, kriya, fotografi, dan DKV dalam ruang publik yang modern.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                ...
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas pengunjung pameran di lantai 1.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                ...
                                <div className="mt-3 rounded-2xl bg-indigo-50 border border-indigo-100 p-4 flex items-center justify-between text-indigo-800">
                                    <h4 className="text-xs font-extrabold">LANTAI 1</h4>
                                    <span className="text-[11px] font-semibold">View Jl. Laswi</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-gray-400 uppercase">EXHIBITION</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Ruang pameran yang fleksibel dengan fasilitas display lengkap dan pencahayaan ideal untuk karya seni & DKV."
                                    </p>
                                </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan reservasi dan tata tertib penggunaan Exhibition Area di Bandung Creative Hub.
                            </p>
                            ...
                            <div className="mt-8 rounded-2xl border border-gray-200 bg-gray-50/80 p-5">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Jam Operasional Pameran</p>
                        ...
                        <div className="lg:col-span-7 space-y-4">
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-gray-200">
                                <div className="flex items-start gap-4">
                                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-indigo-100 text-xs font-bold text-indigo-700">1</span>
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Pengecekan Jadwal & Hotline</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Cek ketersediaan jadwal melalui <strong className="text-gray-700">linktr.ee/creativehub_bdg</strong>, lalu konfirmasi ke hotline di jam 08.00–16.00 WIB dengan melampirkan KTP Kota Bandung.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-gray-200">
                                <div className="flex items-start gap-4">
                                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-indigo-100 text-xs font-bold text-indigo-700">2</span>
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Surat Pengajuan H-3</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Membuat Surat Pengajuan & Lembar Deskripsi Kegiatan (Tema Acara, Rundown, Jumlah Peserta, Waktu Pelaksanaan) dan diserahkan ke Front Office UPTD paling lambat H-3.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-gray-200">
                                <div className="flex items-start gap-4">
                                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-indigo-100 text-xs font-bold text-indigo-700">3</span>
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Titip KTP & Daftar Peralatan</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Pengaju wajib melampirkan daftar alat yang dibawa. Selama pameran berlangsung, penanggung jawab wajib menyimpan KTP kepada Operator yang bertugas.
                                        </p>
                                    </div>
                                </div>
                            </div>

                            <div className="rounded-2xl border border-indigo-200 bg-indigo-50/50 p-6 shadow-xs transition hover:bg-indigo-50/80">
                                <div className="flex items-start gap-4">
                                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-indigo-600 text-xs font-bold text-white">4</span>
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Proses Hotline Resmi</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-600">
                                            Pengajuan Exhibition Area hanya diproses resmi melalui hotline Bandung Creative Hub pada jam kerja operasional.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">Foto Pameran {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
