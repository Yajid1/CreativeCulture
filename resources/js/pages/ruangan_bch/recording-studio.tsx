...
export default function RecordingStudio({ room }: { room?: UserRoomData | null }) {
    ...
    return (
        <>
            <Head title="Recording Studio (Lt.3) - Bandung Creative Hub" />
            ...
            <div className="min-h-screen bg-white text-gray-900 font-sans">
                ...
                <main className="mx-auto max-w-7xl px-6 py-16 sm:px-12 lg:px-20 space-y-24">
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            <h1 className="mt-3 text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Recording Studio (Lt.3)
                            </h1>
                            <p className="mt-2 text-sm font-semibold text-gray-500">
                                Bandung Creative Hub
                            </p>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Studio yang terletak di lantai 3 ini merupakan ruang produksi musik di Bandung Creative Hub. Beragam aktivitas rekaman musik baik project solo, duo, band, tapping voice over, hingga rekaman berbasis suara dapat diselenggarakan di studio profesional ini.
                            </p>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm">
                                <img
                                    ...
                                    alt="Recording Studio Bandung Creative Hub"
                    ...
                    {/* ===== ROW 2: PRO AUDIO & GEAR (IMAGE LEFT, TEXT RIGHT) ===== */}
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-2 lg:order-1 lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm">
                                <img
                                    ...
                                    alt="Fasilitas Rekaman Audio BCH"
                                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                                />
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Fasilitas Pro Audio & Instrumen
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Dilengkapi instrumen dan gear pro audio tingkat industri musik profesional untuk menghasilkan kualitas produksi suara terbaik.
                            </p>

                            {/* Facilities Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Peralatan Studio Rekaman:</p>
                                <div className="flex flex-wrap gap-2 text-xs">
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 font-semibold text-gray-700">🥁 Drum Akustik Sakae</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 font-semibold text-gray-700">🎸 Fender Stratocaster & Cort Acoustic</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 font-semibold text-gray-700">🎸 Fender Jazz Bass & Acoustic Bass</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 font-semibold text-gray-700">🔊 Amp Marshall JCM900 & Behringer VT250X</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 font-semibold text-gray-700">🎤 Mic Dynamic & Condenser</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 font-semibold text-gray-700">🎛️ Preamp Neve 1073 DPA & API 123</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 font-semibold text-gray-700">💻 Apogee Symphony MKII & Radial DI Box</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 font-semibold text-gray-700">📢 Speaker Monitor Adam S1X</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 font-semibold text-gray-700">🎚️ Cubase, Pro Tools, Logic Pro X, Studio One</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Studio Produksi Musik & Voice Over Standar Industri Musik.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Menyediakan fasilitas rekaman komplit di lantai 3 gedung Bandung Creative Hub.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                ...
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas maksimal orang dalam studio rekaman.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                <div className="flex flex-1 flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 bg-[#F4F4F5] p-5 text-center">
                                    <h4 className="text-xl font-extrabold text-gray-900">08.30–16.00</h4>
                                    <p className="mt-1 text-xs font-semibold text-gray-500">WIB Jam Operasional</p>
                                </div>

                                <div className="mt-3 rounded-2xl bg-violet-50 border border-violet-100 p-4 flex items-center justify-between text-violet-800">
                                    <h4 className="text-xs font-extrabold">NEVE 1073</h4>
                                    <span className="text-[11px] font-semibold">Apogee Symphony</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#F4F4F5] p-6 min-h-[260px]">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-gray-900">Audio Engineer Mandiri</h4>
                                    <p className="mt-1 text-xs text-gray-500 leading-relaxed">
                                        Pengguna diwajibkan membawa audio engineer sendiri (operator memberikan brief singkat).
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-gray-400 uppercase">RECORDING</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Kualitas Preamp Neve 1073 dan Monitor Adam S1X di Recording Studio BCH sangat memanjakan hasil mixing rekaman."
                                    </p>
                                </div>

                                <p className="text-[11px] font-semibold text-gray-400">
                                    • Audio Producer Bandung
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Syarat dan ketentuan penggunaan fasilitas Recording Studio di lantai 3 Bandung Creative Hub.
                            </p>
                            ...
                            <div className="mt-8 rounded-2xl border border-gray-200 bg-gray-50/80 p-5">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Jam Operasional Rekaman</p>
                                        <p className="text-sm font-extrabold text-gray-900">08.30 – 16.00 WIB</p>
                                    </div>
                                </div>
                        ...
                        <div className="lg:col-span-7 space-y-4">
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-gray-200">
                                <div className="flex items-start gap-4">
                                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-violet-100 text-xs font-bold text-violet-700">1</span>
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Persyaratan KTP & Lampiran Rekaman</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Pengaju wajib ber-KTP Kota Bandung, disertai lampiran jumlah personil, kebutuhan alat, dan jenis musik yang direkam.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-gray-200">
                                <div className="flex items-start gap-4">
                                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-violet-100 text-xs font-bold text-violet-700">2</span>
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Pengajuan via Hotline Resmi</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Pengajuan Recording Studio hanya diproses melalui hotline Bandung Creative Hub di jam kerja 08.00–16.00 WIB.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-gray-200">
                                <div className="flex items-start gap-4">
                                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-violet-100 text-xs font-bold text-violet-700">3</span>
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Membawa Audio Engineer Mandiri</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Pengguna diwajibkan membawa audio engineer secara mandiri. Operator UPTD akan memberikan briefing pengenalan singkat fasilitas studio.
                                        </p>
                                    </div>
                                </div>
                            </div>

                            <div className="rounded-2xl border border-violet-200 bg-violet-50/50 p-6 shadow-xs transition hover:bg-violet-50/80">
                                <div className="flex items-start gap-4">
                                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-violet-600 text-xs font-bold text-white">4</span>
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Registrasi & Titip KTP di Front Office</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-600">
                                            Mengisi Surat Pernyataan sebelum sesi dimulai, dan penanggung jawab wajib menyimpan KTP kepada Operator yang bertugas selama rekaman.
                                        </p>
                                    </div>
                                </div>
                            </div>
