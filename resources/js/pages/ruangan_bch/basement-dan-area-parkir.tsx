    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-white text-gray-900 font-sans">
                ...
                {/* ===== MAIN CONTENT (SECTION STRUCTURE WITH PLACEHOLDERS) ===== */}
                <main className="mx-auto max-w-7xl px-6 py-16 sm:px-12 lg:px-20 space-y-24">
                    ...
                    {/* ===== ROW 2: ALTERNATIF VENUE KREATIF (PLACEHOLDER LEFT, TEXT RIGHT) ===== */}
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        {/* Image Left */}
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        {/* Section Header (Big Bold Title + Subtitle) */}
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Menghadirkan fasilitas terpadu, memberikan kenyamanan beraktivitas di area basement BCH.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Mendukung efisiensi sirkulasi kendaraan serta memfasilitasi ragam pameran dan karya kreatif komunitas setiap hari.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                <div>
                                    ...
                                    <h3 className="mt-8 text-4xl sm:text-5xl font-extrabold tracking-tight">200+</h3>
                                </div>
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Daya tampung kendaraan sepeda motor yang teratur dan aman di area lantai dasar.
                                </p>
                            </div>

                            {/* Card 2: Split Dashed / Solid Card */}
                            <div className="flex flex-col justify-between min-h-[260px]">
                                ...
                                <div className="flex flex-1 flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 bg-[#F4F4F5] p-5 text-center">
                                    <div className="flex items-center -space-x-2">
                                        <span className="flex h-9 w-9 items-center justify-center rounded-full bg-blue-500 text-white text-xs font-bold ring-2 ring-white">🎨</span>
                                        <span className="flex h-9 w-9 items-center justify-center rounded-full bg-purple-500 text-white text-xs font-bold ring-2 ring-white">🎬</span>
                                        <span className="flex h-9 w-9 items-center justify-center rounded-full bg-emerald-500 text-white text-xs font-bold ring-2 ring-white">✨</span>
                                        <span className="flex h-9 w-9 items-center justify-center rounded-full bg-amber-500 text-white text-xs font-bold ring-2 ring-white">📷</span>
                                    </div>
                                    <p className="mt-3 text-xs font-semibold text-gray-500">17 Subsektor Ekraf</p>
                                </div>

                                {/* Solid Lower Box */}
                                <div className="mt-3 rounded-2xl bg-[#F4F4F5] p-4 flex items-center justify-between">
                                    <h4 className="text-xl font-extrabold text-gray-900">08–21</h4>
                                    <span className="text-xs font-medium text-gray-500">WIB Operasional Harian</span>
                                </div>
                            </div>

                            {/* Card 3: Speedometer / Radial Security Card */}
                            <div className="flex flex-col justify-between rounded-3xl bg-[#F4F4F5] p-6 min-h-[260px]">
                                <div className="flex items-center justify-center py-2">
                                    <div className="relative flex h-24 w-24 items-center justify-center rounded-full border-4 border-gray-200/80 border-t-gray-900 border-r-gray-900 transition-transform duration-700">
                                        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-900 text-white shadow-xs">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-gray-900">Pengawasan 24/7</h4>
                                    <p className="mt-1 text-xs text-gray-500 leading-relaxed">
                                        Sistem pemantauan & pengawasan keamanan di seluruh area basement.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-gray-400 uppercase">BCH HUB</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Basement yang tertib untuk parkir sekaligus menginspirasi dengan galeri lukisan mural karya komunitas seni."
                                    </p>
                                </div>

                                <p className="text-[11px] font-semibold text-gray-400">
                                    • Komunitas Seni Bandung
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Harap senantiasa mematuhi aturan dan ketentuan bersama demi menjaga keamanan, ketertiban, serta kelestarian fasilitas publik di Bandung Creative Hub.
                            </p>
                            ...
                            <div className="mt-8 rounded-2xl border border-gray-200 bg-gray-50/80 p-5">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Jam Operasional Basement</p>
                        ...
                        <div className="lg:col-span-7 space-y-4">
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-gray-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Parkir Tertib & Keamanan Barang</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Parkirkan kendaraan dengan tertib pada area yang disediakan, dan senantiasa menjaga serta memperhatikan keamanan barang bawaan pribadi.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-gray-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Menjaga Fasilitas Bersama</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Harap merawat dan menjaga fasilitas bersama ini secara bijak, termasuk menjaga kebersihan serta kelestarian karya mural seni rupa.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-gray-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Dilarang keras melakukan berbagai aktivitas yang dapat mengganggu ketertiban, keamanan, maupun kenyamanan umum di lingkungan gedung BCH.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-blue-200 bg-blue-50/50 p-6 shadow-xs transition hover:bg-blue-50/80">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-base font-bold text-gray-900">Pengajuan Kegiatan & Reservasi</h4>
                                        <p className="mt-1 text-xs leading-relaxed text-gray-600">
                                            Khusus untuk pengajuan kegiatan (Pameran, Mini Showcase, atau Movieclips), silakan menghubungi <strong className="text-blue-700">Hotline Resmi</strong> atau mendatangi <strong className="text-blue-700">Front Office BCH</strong>.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] overflow-hidden pt-12 pb-6 space-y-5">
                        ...
                        {/* Row 2: Scroll Right (Placeholders) */}
                        <div className="relative w-full overflow-hidden">
