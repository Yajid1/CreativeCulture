...
export default function GedungOutdoor({ room }: { room?: UserRoomData | null }) {
    ...
    const facilitiesList = [
        '🎭 Panggung Outdoor (24 x 6 m)',
        '🔊 Speaker System',
        '🎛️ Audio Mixer',
        '🪑 Kursi Portable (100 Unit)',
        '🌿 Sirkulasi Udara Terbuka & Alami',
        '🎪 Area Pertunjukan & Latihan Terbuka',
    ];

    return (
        <>
            <Head title="Gedung Outdoor - Padepokan Seni Mayang Sunda" />
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3.5 py-1 text-xs font-bold uppercase tracking-wider text-emerald-700">
                                Area Terbuka Kapasitas Terbesar
                            </div>
                            ...
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Outdoor Stage merupakan fasilitas dengan kapasitas terbesar di Mayang Sunda, yang dapat menampung hingga 500 penonton. Selain menjadi venue pertunjukan, beragam aktivitas latihan berkaitan seni dan budaya, dapat terselenggara di area dengan panggung, speaker, dan sirkulasi alami ini.
                            </p>
                            ...
                            <div className="mt-6 flex flex-wrap items-center gap-3">
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-gray-50 border border-gray-100 px-5 py-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-extrabold text-gray-900">500 Orang</p>
                                    </div>
                                </div>
                                ...
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-emerald-50/60 border border-emerald-100 px-5 py-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-medium text-emerald-600 uppercase tracking-wider">Fasilitas Area</p>
                                        <p className="text-base font-extrabold text-gray-900">Outdoor & Sirkulasi Alami</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Gedung Outdoor Padepokan Seni Mayang Sunda"
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-2 lg:order-1 lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Area Panggung Gedung Outdoor Mayang Sunda"
                                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                                />
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Panggung Outdoor & Peralatan Pendukung
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Memiliki panggung berukuran 24 x 6 m yang luas, didukung sistem pengeras suara (speaker & mixer), serta 100 unit kursi portable yang fleksibel untuk berbagai tata letak acara.
                            </p>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Ruang Pertunjukan & Latihan Terbuka di Mayang Sunda.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Menyediakan panggung terbuka 24x6m dengan kapasitas hingga 500 penonton untuk pagelaran seni, festival budaya, serta latihan komunitas.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                <div>
                                    ...
                                    <h3 className="mt-8 text-4xl sm:text-5xl font-extrabold tracking-tight text-white">500</h3>
                                </div>
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas penonton terbuka terbesar di Padepokan Seni Mayang Sunda.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                ...
                                <div className="mt-3 rounded-2xl bg-emerald-600 text-white p-4 flex items-center justify-between">
                                    <h4 className="text-xs font-extrabold uppercase">PANGGUNG 24x6M</h4>
                                    <span className="text-[11px] font-semibold text-emerald-100">100 Kursi Portable</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-emerald-600 uppercase">OUTDOOR STAGE</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Area panggung outdoor Mayang Sunda sangat leluasa untuk pagelaran seni tradisional dan atraksi budaya terbuka."
                                    </p>
                                </div>

                                <p className="text-[11px] font-semibold text-gray-400">
                                    • Penggiat Seni Budaya Bandung
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan dan syarat penggunaan Gedung Outdoor di Padepokan Seni Mayang Sunda.
                            </p>
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">FOTO GEDUNG OUTDOOR {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
