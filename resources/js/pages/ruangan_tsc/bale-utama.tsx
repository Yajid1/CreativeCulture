...
export default function BaleUtama({ room }: { room?: UserRoomData | null }) {
    ...
    const facilitiesList = [
        '🏛️ Aula Utama & Fasilitas Terbesar (Kapasitas 300 Orang)',
        '🎭 Panggung Utama Pertunjukan & Pementasan Seni Budaya',
        '🔊 Sound System Utama & Pengeras Suara Terpadu',
        '💡 Tata Pencahayaan (Lighting Panggung & Aula)',
        '🪵 Arsitektur Atap Kubah & Ornamen Bambu Khas Sunda',
        '🪑 Area Penonton & Kursi Acara Luas',
    ];

    return (
        <>
            <Head title="Balé Utama - Teras Sunda Cibiru" />
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Balé Utama merupakan aula utama dan fasilitas terbesar di Teras Sunda Cibiru, dengan kapasitas maksimal 300 orang. Berbagai macam pementasan seni-budaya bisa digelar di aula tertutup dengan ornamen dan nuansa bambu yang khas.
                            </p>
                            ...
                            <div className="mt-6 flex flex-wrap items-center gap-3">
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-gray-50 border border-gray-100 px-5 py-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-extrabold text-gray-900">300 Orang</p>
                                    </div>
                                </div>
                                ...
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-emerald-50/60 border border-emerald-100 px-5 py-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-medium text-emerald-600 uppercase tracking-wider">Fasilitas Utama</p>
                                        <p className="text-base font-extrabold text-gray-900">Aula Pertunjukan Puncak</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Balé Utama Teras Sunda Cibiru"
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-2 lg:order-1 lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Arsitektur Bambu Balé Utama"
                                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                                />
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Aula Pertunjukan Seni & Budaya
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Balé Utama memiliki desain kubah bambu megah khas Jawa Barat dengan panggung luas dan tata sistem suara/cahaya lengkap untuk memfasilitasi festival, pergelaran wayang, musik etnis, dan teater berskala besar.
                            </p>

                            {/* Facilities Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Daftar Fasilitas Balé Utama:</p>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Venue Pementasan Seni Terbesar di Teras Sunda Cibiru.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Aula tertutup berkapasitas 300 orang dengan akustik alami dari elemen bambu untuk pergelaran seni akbar.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                <div>
                                    ...
                                    <h3 className="mt-8 text-4xl sm:text-5xl font-extrabold tracking-tight text-white">300</h3>
                                </div>
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas penonton maksimal aula pementasan seni.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                <div className="flex flex-1 flex-col items-center justify-center rounded-2xl border-2 border-dashed border-emerald-200 bg-emerald-50/40 p-5 text-center">
                                    ...
                                    <p className="mt-1 text-xs font-semibold text-emerald-700">Pertunjukan & Pementasan Seni-budaya</p>
                                </div>

                                <div className="mt-3 rounded-2xl bg-emerald-600 text-white p-4 flex items-center justify-between">
                                    <h4 className="text-xs font-extrabold uppercase">BALÉ UTAMA</h4>
                                    <span className="text-[11px] font-semibold text-emerald-100">Kubah Bambu</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-emerald-600 uppercase">BALÉ UTAMA</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Keunikan arsitektur dan megahnya aula Balé Utama menjadikan setiap pagelaran seni terasa sangat magis dan autentik."
                                    </p>
                                </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan pementasan dan syarat penggunaan Balé Utama di Teras Sunda Cibiru.
                            </p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Cek ketersediaan jadwal pementasan di fitur live schedule resmi Teras Sunda Cibiru.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-emerald-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Konfirmasi ketersediaan aula ke hotline Teras Sunda Cibiru di jam 08.00–16.00 WIB, dengan melampirkan KTP Kota Bandung dan daftar rincian alat yang akan digunakan.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-600">
                                            Selama acara pementasan berlangsung, penanggung jawab <strong className="text-emerald-800">wajib menyimpan KTP ke Operator / Sekuriti yang bertugas</strong>.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">FOTO BALÉ UTAMA {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
