        ...
        <>
            ...
            <header className="sticky top-0 z-40 border-b border-gray-100 bg-white/90 backdrop-blur-md">
                <div className="flex items-center justify-between gap-6 px-6 py-4 sm:px-10">
                    ...
                    {/* Nav links */}
                    <nav className="hidden items-center gap-7 text-sm font-medium text-gray-500 lg:flex">
                        <Link href="/" className="transition hover:text-gray-900">Home</Link>
                        <Link href="/#works" className="transition hover:text-gray-900">Work</Link>
                        <Link href="/#services" className="transition hover:text-gray-900">
                            Services <span className="text-xs opacity-60">▾</span>
                        </Link>
                        <Link href="/#about" className="transition hover:text-gray-900">Studio</Link>
                        <Link href="/#careers" className="transition hover:text-gray-900">Careers</Link>
