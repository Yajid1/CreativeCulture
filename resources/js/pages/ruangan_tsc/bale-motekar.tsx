...
export default function BaleMotekar({ room }: { room?: UserRoomData | null }) {
    ...
    const facilitiesList = [
        '🏡 Studio Intim Beraspek Rumah Etnis Sunda',
        '💡 Ruang Diskusi, Workshop & Penciptaan Karya',
        '🪵 Meja & Kursi Latihan Diskusi Kreatif',
        '🔌 Stop Kontak & Fasilitas Presentasi Karya',
        '🌿 Suasana Asri & Tenang di Lingkungan Cibiru',
        '👥 Kapasitas Intim Hingga 10 Orang',
    ];

    return (
        <>
            <Head title="Balé Motekar - Teras Sunda Cibiru" />
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Selain latihan dan pementasan, Teras Sunda Cibiru juga memfasilitasi aktivitas workshop, diskusi, hingga praktik penciptaan karya. Bagi wargi yang ingin menggelar aktivitas tersebut di studio dengan kapasitas 10 orang, silakan akses Balé Motékar.
                            </p>
                            ...
                            <div className="mt-6 flex flex-wrap items-center gap-3">
                                ...
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-emerald-50/60 border border-emerald-100 px-5 py-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-extrabold text-gray-900">Workshop & Brainstorming</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Balé Motekar Teras Sunda Cibiru"
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-2 lg:order-1 lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Fasilitas Diskusi Balé Motekar"
                                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                                />
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Ruang Penciptaan Karya & Workshop Intim
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Berkonsep rumah panggung etnis Sunda yang hangat dan privat, Balé Motékar memfasilitasi diskusi ide kreatif, lokakarya keterampilan, dan penyusunan konsep karya.
                            </p>

                            {/* Facilities Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Daftar Fasilitas Balé Motékar:</p>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Studio Workshop & Penciptaan Karya di Teras Sunda Cibiru.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Mewadahi diskusi kelompok kecil, workshop seni kriya/desain, dan curah gagasan karya budaya.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                ...
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas maksimal orang per sesi workshop & diskusi.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                <div className="flex flex-1 flex-col items-center justify-center rounded-2xl border-2 border-dashed border-emerald-200 bg-emerald-50/40 p-5 text-center">
                                    ...
                                    <p className="mt-1 text-xs font-semibold text-emerald-700">Workshop & Diskusi Karya</p>
                                </div>

                                <div className="mt-3 rounded-2xl bg-emerald-600 text-white p-4 flex items-center justify-between">
                                    <h4 className="text-xs font-extrabold uppercase">BALÉ MOTÉKAR</h4>
                                    <span className="text-[11px] font-semibold text-emerald-100">Studio Intim</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#F4F4F5] p-6 min-h-[260px]">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="mt-1 text-xs text-gray-500 leading-relaxed">
                                        Pengajuan workshop diproses via Hotline Teras Sunda Cibiru di jam 08.00–16.00 WIB.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-emerald-600 uppercase">BALÉ MOTÉKAR</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Atmosfer rumah kayu tradisional di Balé Motékar sangat nyaman untuk sesi curah pendapat dan lokakarya karya etnis."
                                    </p>
                                </div>

                                <p className="text-[11px] font-semibold text-gray-400">
                                    • Pengrajin Kriya Bandung
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan workshop dan syarat penggunaan Balé Motékar di Teras Sunda Cibiru.
                            </p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Cek ketersediaan jadwal workshop di fitur live schedule resmi Teras Sunda Cibiru.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-emerald-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Konfirmasi ketersediaan ke hotline Teras Sunda Cibiru di jam 08.00–16.00 WIB, dengan melampirkan KTP Kota Bandung dan deskripsi materi workshop/diskusi.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-emerald-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Membuat Surat Pengajuan dan Lembar Deskripsi Kegiatan Workshop lalu serahkan ke Front Office UPTD sebelum kegiatan.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-600">
                                            Selama kegiatan workshop berlangsung, penanggung jawab <strong className="text-emerald-800">wajib menyimpan KTP ke Operator / Sekuriti yang bertugas</strong>.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">FOTO BALÉ MOTÉKAR {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
