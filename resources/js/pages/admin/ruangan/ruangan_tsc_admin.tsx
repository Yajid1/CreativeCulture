...
const initialProjects: Project[] = [
    {
        id: 1,
        name: 'Balé Utama Audio Console',
        description: 'Digital audio snake cable & stage box setup...',
        status: 'Ready',
    ...
    {
        id: 2,
        name: 'Palataran Open-Air Stage Rigging',
        description: 'Truss structure & outdoor canopy safety check...',
        status: 'Ready',
        environment: 'Production',
        lastUpdated: '07/22/2026',
    },
    {
        id: 3,
        name: 'Balé Alit Workshop Furniture',
        description: 'Modular tables and ergonomic seating for craft workshops...',
        status: 'In Progress',
        environment: 'Staging',
    ...
    {
        id: 4,
        name: 'Balé Riung VIP Air Conditioning',
        description: 'Dual inverter AC unit installation & thermostat setup...',
        status: 'Ready',
        environment: 'Production',
    ...
    {
        id: 5,
        name: 'Balé Motékar Interactive Screen',
        description: 'Multi-touch wall display & digital gallery software...',
        status: 'Blocked',
...
export default function RuanganTSCAdmin() {
    ...
    return (
        <>
            <Head title="All Projects - Ruangan TSC Admin" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">
                            Manage development projects and deployments (Ruangan TSC)
                        </p>
                    </div>
