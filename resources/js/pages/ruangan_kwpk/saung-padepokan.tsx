...
export default function SaungPadepokan({ room }: { room?: UserRoomData | null }) {
    ...
    const facilitiesList = [
        '🏡 Saung Kayu & Bambu Tradisional',
        '🪵 Area Lesehan Diskusi & Sarasehan',
        '🔊 Sound System Portabel',
        '🌄 Pemandangan Panorama Kota Bandung & Kaki Gunung',
        '🌿 Udara Segar & Suasana Asri Pedesaan',
        '👥 Kapasitas Berkelompok Hingga 30 Orang',
    ];

    return (
        <>
            <Head title="Saung Padepokan - Kampung Wisata Pasir Kunci" />
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3.5 py-1 text-xs font-bold uppercase tracking-wider text-emerald-700">
                                Saung Tradisional Budaya Sunda
                            </div>
                            ...
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Saung Padepokan merupakan saung tradisional berkonsep kebudayaan Sunda di Kampung Wisata Pasir Kunci yang berkapasitas 30 orang. Berada di kaki Gunung Manglayang dengan panorama alam Kota Bandung, saung ini sangat ideal untuk sarana kumpul komunitas, sarasehan budaya, latihan pencak silat, dan sarana edukasi seni tradisional.
                            </p>
                            ...
                            <div className="mt-6 flex flex-wrap items-center gap-3">
                                ...
                                <div className="inline-flex items-center gap-3 rounded-2xl bg-emerald-50/60 border border-emerald-100 px-5 py-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-extrabold text-gray-900">Saung Terbuka</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm border border-gray-100">
                                <img
                                    ...
                                    alt="Saung Padepokan Pasir Kunci"
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Suasana Khas Pedesaan & Suasana Alam
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Menawarkan keindahan alam pegunungan dengan arsitektur saung bambu khas Pasir Kunci yang menyejukkan, cocok untuk berbagai kegiatan diskusi dan edukasi budaya.
                            </p>

                            {/* Facilities Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Daftar Fasilitas Saung Padepokan:</p>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Ruang Sarasehan & Edukasi Budaya Sunda di Pasir Kunci.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Menyediakan saung bambu lesehan berkapasitas 30 orang berlatar pemandangan pegunungan dan panorama Kota Bandung.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                <div>
                                    ...
                                    <h3 className="mt-8 text-4xl sm:text-5xl font-extrabold tracking-tight text-white">30</h3>
                                </div>
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas pengunjung di area saung padepokan.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                ...
                                <div className="mt-3 rounded-2xl bg-emerald-600 text-white p-4 flex items-center justify-between">
                                    <h4 className="text-xs font-extrabold uppercase">SAUNG PADEPOKAN</h4>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    ...
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Suasana sejuk di Saung Padepokan sangat menenangkan untuk sarasehan kebudayaan dan kumpul komunitas."
                                    </p>
                                </div>

                                <p className="text-[11px] font-semibold text-gray-400">
                                    • Penggiat Wisata Budaya
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan dan syarat penggunaan Saung Padepokan di Kampung Wisata Pasir Kunci.
                            </p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Cek ketersediaan jadwal penggunaan saung di fitur live schedule resmi Pasir Kunci.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-emerald-200">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-relaxed text-gray-500">
                                            Konfirmasi ketersediaan saung ke hotline Pasir Kunci di jam 08.00–16.00 WIB, dengan melampirkan KTP Kota Bandung.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">FOTO SAUNG PADEPOKAN {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
