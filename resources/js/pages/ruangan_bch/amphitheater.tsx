...
export default function Amphitheater() {
    ...
    return (
        <>
            <Head title="Amphitheater (Lt.1) - Bandung Creative Hub" />
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm">
                                <img
                                    ...
                                    alt="Amphitheater Bandung Creative Hub"
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-2 lg:order-1 lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm">
                                <img
                                    ...
                                    alt="Fasilitas Amphitheater BCH"
                                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                                />
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Public Space & Kelengkapan
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Konsep interior kayu yang hangat dan tangga bertingkat memberikan fleksibilitas tinggi bagi pengunjung untuk bekerja santai, berdiskusi, maupun menggelar pertunjukan mini.
                            </p>
                            ...
                            <div className="animate-marquee-scroll-left gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">Foto Amphitheater {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
