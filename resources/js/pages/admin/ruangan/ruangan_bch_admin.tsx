...
const initialProjects: Project[] = [
    {
        id: 1,
        name: 'Digital Content Studio Equipment Suite',
        description: '4K cameras & podcast mic setup for content creators...',
        status: 'Ready',
    ...
    {
        id: 2,
        name: 'Coworking Space WiFi Expansion',
        description: 'Mesh WiFi 6 router setup & power outlet addition...',
        status: 'Ready',
        environment: 'Production',
        lastUpdated: '07/22/2026',
    },
    {
        id: 3,
        name: 'Auditorium Projector & Screen',
        description: 'Laser projector alignment and motorized screen replacement...',
        status: 'In Progress',
        environment: 'Staging',
    ...
    {
        id: 4,
        name: 'Recording Studio Soundproofing',
        description: 'Acoustic diffuser panels and vocal booth isolation...',
        status: 'Ready',
        environment: 'Production',
    ...
    {
        id: 5,
        name: 'Fashion Studio Sewing Machines',
        description: 'Industrial sewing machine calibration and safety check...',
        status: 'Blocked',
...
export default function RuanganBCHAdmin() {
    ...
    return (
        <>
            <Head title="All Projects - Ruangan BCH Admin" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">
                            Manage development projects and deployments (Ruangan BCH)
                        </p>
                    </div>
