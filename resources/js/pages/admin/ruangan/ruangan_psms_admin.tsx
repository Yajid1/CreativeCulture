...
const initialProjects: Project[] = [
    {
        id: 1,
        name: 'Indoor Stage Lighting Setup',
        description: 'DMX spotlight & ambient background lighting management...',
        status: 'Ready',
    ...
    {
        id: 2,
        name: 'Gedung Outdoor Seating Capacity',
        description: 'Tiered seating expansion & temporary awning setup...',
        status: 'Ready',
        environment: 'Production',
        lastUpdated: '07/22/2026',
    },
    {
        id: 3,
        name: 'Studio Musik Mayang Sunda Mixer',
        description: 'Multi-channel audio mixing board setup...',
        status: 'In Progress',
        environment: 'Staging',
    ...
    {
        id: 4,
        name: 'Backstage Dressing Room Refurbishment',
        description: 'Mirror lighting and costume rack installation...',
        status: 'Ready',
        environment: 'Production',
    ...
    {
        id: 5,
        name: 'PSMS Security & Access Control',
        description: 'RFID door access badge & CCTV integration...',
        status: 'Blocked',
...
export default function RuanganPSMSAdmin() {
    ...
    return (
        <>
            <Head title="All Projects - Ruangan PSMS Admin" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">
                            Manage development projects and deployments (Ruangan PSMS)
                        </p>
                    </div>
