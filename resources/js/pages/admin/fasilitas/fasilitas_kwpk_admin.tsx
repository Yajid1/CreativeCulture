...
const initialProjects: Project[] = [
    {
        id: 1,
        name: 'Saung Padepokan Cultural Gazebo',
        description: 'Traditional bamboo renovation & solar lighting system...',
        status: 'Ready',
    ...
    {
        id: 2,
        name: 'Balé Puhun Executive Lounge',
        description: 'Wooden structure weatherproofing & sound system installation...',
        status: 'Ready',
        environment: 'Production',
        lastUpdated: '07/22/2026',
    },
    {
        id: 3,
        name: 'Wahana Kaulinan Outdoor Arena',
        description: 'Children traditional game arena safety mat installation...',
        status: 'In Progress',
        environment: 'Staging',
    ...
    {
        id: 4,
        name: 'Kalang Amphitheater Sound Rig',
        description: 'Open air acoustics & perimeter lighting installation...',
        status: 'Ready',
        environment: 'Production',
    ...
    {
        id: 5,
        name: 'Pasir Kunci Mobile Tour Guide App',
        description: 'Interactive AR tour map & cultural storytelling module...',
        status: 'Blocked',
...
export default function KWPKAdmin() {
    ...
    return (
        <>
            <Head title="All Projects - Kampung Wisata Pasir Kunci Admin" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">
                            Manage development projects and deployments (Kampung Wisata Pasir Kunci)
                        </p>
                    </div>
