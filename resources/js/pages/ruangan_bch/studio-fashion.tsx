...
export default function StudioFashion({ room }: { room?: UserRoomData | null }) {
    ...
    return (
        <>
            <Head title="Studio Fashion (Lt.5) - Bandung Creative Hub" />
            ...
            <div className="min-h-screen bg-white text-gray-900 font-sans">
                ...
                <main className="mx-auto max-w-7xl px-6 py-16 sm:px-12 lg:px-20 space-y-24">
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Studio yang terletak di lantai 5 ini merupakan ruang khusus aktivitas fesyen. Berbagai aktivitas berkaitan fesyen seperti modeling class, makeup class, mini catwalk, serta workshop fashion bisa diselenggarakan di studio ini.
                            </p>
                        ...
                        <div className="lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm">
                                <img
                                    ...
                                    alt="Studio Fashion Bandung Creative Hub"
                    ...
                    {/* ===== ROW 2: FASHION ACTIVITIES & SOUND (IMAGE LEFT, TEXT RIGHT) ===== */}
                    <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
                        ...
                        <div className="order-2 lg:order-1 lg:col-span-7">
                            <div className="relative h-[360px] sm:h-[450px] w-full overflow-hidden rounded-3xl shadow-sm">
                                <img
                                    ...
                                    alt="Fasilitas Studio Fesyen BCH"
                                    className="h-full w-full object-cover transition-transform duration-700 hover:scale-105"
                                />
                            </div>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 lg:col-span-5">
                            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.15]">
                                Mini Catwalk & Workshop Fesyen
                            </h2>
                            <p className="mt-5 text-base sm:text-lg text-gray-500 leading-relaxed">
                                Sangat ideal untuk tempat penyelenggaraan Modeling Class, MakeUp Class, Mini Catwalk, hingga Workshop Fesyen bagi komunitas dan penggiat busana Kota Bandung.
                            </p>

                            {/* Facilities Badges */}
                            <div className="mt-6 space-y-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Peralatan Studio Fesyen:</p>
                                <div className="flex flex-wrap gap-2 text-xs">
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">🪑 Kursi & Meja Panjang</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">👠 Mini Catwalk & Modeling Runway</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">💄 MakeUp Class Setup</span>
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">🎤 Microphone Pro</span>
                                    ...
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3.5 py-2 font-semibold text-gray-700">🎛️ Mixer Sound Primatech</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pt-8 pb-4 space-y-10 border-t border-gray-100">
                        ...
                        <div className="max-w-4xl">
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-[1.18]">
                                Studio Aktivitas Fesyen & Runway Mini Catwalk di Lantai 5 BCH.
                            </h2>
                            <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed max-w-2xl">
                                Menyediakan sarana workshop fesyen, kelas modeling, makeup class, dan audio RCF untuk komune desainer & model.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-[#18181b] p-6 text-white min-h-[260px] shadow-sm">
                                ...
                                <p className="mt-4 text-xs leading-relaxed text-gray-400">
                                    Kapasitas maksimal peserta studio fesyen.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col justify-between min-h-[260px]">
                                ...
                                <div className="mt-3 rounded-2xl bg-pink-50 border border-pink-100 p-4 flex items-center justify-between text-pink-800">
                                    <h4 className="text-xs font-extrabold">MINI CATWALK</h4>
                                    <span className="text-[11px] font-semibold">Speaker RCF</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col justify-between rounded-3xl bg-white p-6 border border-gray-100 shadow-xs min-h-[260px]">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] font-extrabold tracking-wider text-gray-400 uppercase">STUDIO FASHION</span>
                                    </div>
                                    <p className="mt-3 text-xs leading-relaxed text-gray-600 font-medium italic">
                                        "Fasilitas mini catwalk dan ruang workshop di lantai 5 sangat fleksibel untuk menyelenggarakan modeling class."
                                    </p>
                                </div>

                                <p className="text-[11px] font-semibold text-gray-400">
                                    • Penggiat Fesyen Bandung
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 pt-4">
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <p className="mt-5 text-base text-gray-500 leading-relaxed">
                                Tata cara pengajuan reservasi dan pembagian sesi Studio Fashion di lantai 5 Bandung Creative Hub.
                            </p>
                            ...
                            <div className="mt-8 rounded-2xl border border-gray-200 bg-gray-50/80 p-5 space-y-3">
                                ...
                                <div className="space-y-2 text-xs font-bold text-gray-800">
                                    <div className="flex items-center justify-between rounded-xl bg-white px-4 py-2.5 border border-gray-100">
                                        <span>Sesi 1</span>
                                        <span className="text-pink-600">08.00 – 12.00 WIB</span>
                                    </div>
                                    <div className="flex items-center justify-between rounded-xl bg-white px-4 py-2.5 border border-gray-100">
                                        <span>Sesi 2</span>
                                        <span className="text-pink-600">13.00 – 17.00 WIB</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7 space-y-4">
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-gray-200">
                                <div className="flex items-start gap-4">
                                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-pink-100 text-xs font-bold text-pink-700">1</span>
                                    <div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-gray-200">
                                <div className="flex items-start gap-4">
                                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-pink-100 text-xs font-bold text-pink-700">2</span>
                                    <div>
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-xs transition hover:border-gray-200">
                                <div className="flex items-start gap-4">
                                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-pink-100 text-xs font-bold text-pink-700">3</span>
                                    <div>
                            ...
                            <div className="rounded-2xl border border-pink-200 bg-pink-50/50 p-6 shadow-xs transition hover:bg-pink-50/80">
                                <div className="flex items-start gap-4">
                                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-pink-600 text-xs font-bold text-white">4</span>
                                    <div>
                            ...
                            <div className="animate-marquee-scroll-right gap-5">
                                {[...Array(12)].map((_, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-semibold uppercase tracking-wider text-gray-400">Foto Studio Fashion {idx + 1}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
